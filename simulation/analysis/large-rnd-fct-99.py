...
if __name__ == "__main__":
  ...
  path_to_clos_fct_file = "../mix/failure-exps/large/output/clos/random/%d/fct.txt"
  path_to_disjoint_fct_file = "../mix/failure-exps/large/output/disjoint/random/%d/fct.txt"
  path_to_ecmp_fct_file = "../mix/failure-exps/large/output/ecmp/random/%d/fct.txt"
  path_to_edst_fct_file = "../mix/failure-exps/large/output/edst/random/%d/fct.txt"
