...
if __name__ == "__main__":
  ...
  path_to_clos_fct_file = "../mix/failure-exps/large/output/clos/worst/%d/fct.txt"
  path_to_disjoint_fct_file = "../mix/failure-exps/large/output/disjoint/worst/%d/fct.txt"
  path_to_ecmp_fct_file = "../mix/failure-exps/large/output/ecmp/worst/%d/fct.txt"
  path_to_edst_fct_file = "../mix/failure-exps/large/output/edst/worst/%d/fct.txt"
  ...
  print('worst clos=', clos)
  print('worst ecmp=', ecmps)
