...
#   fat_fct_fmt = "../mix/output/fat-tree/dcqcn/cs-model/pfc/web/C%d-S%d/fct.txt"
  ...
  fat_fct_fmt = "../mix/output/edst-weighted/dcqcn/cs-model/64/pfc/web/C%d-S%d/fct.txt"
  fc_ecmp_fct_fmt = "../mix/output/fc-weighted/dcqcn/cs-model/64/pfc/web/C%d-S%d/fct.txt"
