  ...
  bool enablePfc)
{
  ...
  SetAttribute ("NonShortest", UintegerValue (non_shortest));
  SetAttribute ("EnableSack", BooleanValue (enableSack));
  SetAttribute ("EnableIRN", BooleanValue (enableIRN));
  // std::cout << "rdmahelper: irn " << enableIRN << "\n";
  SetAttribute ("EnablePfc", BooleanValue (enablePfc));
}
